  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-white dark:bg-slate-900 text-center p-8 animate-fade-in">
      ...
      <p className="text-lg max-w-2xl text-slate-600 dark:text-slate-300 mb-8">
        أطلق العنان للكيميائي بداخلك! استكشف عالم الذرات، شاهد تفاعلات المركبات، اغوص في عوالم الكيمياء العضوية والحيوية والكهربائية، واكشف عن الطاقة الكامنة في التفاعلات الكيميائية الحرارية. أداة تفاعلية شاملة بين يديك.
      </p>
      <button
        onClick={onStart}
